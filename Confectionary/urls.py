...
urlpatterns = [
    ...
    path("showcase/", views.showcase, name="showcase_all"),
    path('showcase/<slug:type_slug>/', views.showcase, name='showcase_by_type'),
    ...
    path("trolley/add/<slug:product_slug>/", views.trolley_add, name="trolley_add"),
    path("trolley/update/<slug:product_slug>/", views.trolley_update, name="trolley_update"),
    path("trolley/remove/<slug:product_slug>/", views.trolley_remove, name="trolley_remove"),
